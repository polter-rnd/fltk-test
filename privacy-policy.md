...
Pavel built the Pure Calculator app as a free app. This SERVICE is provided by Pavel at no cost and is intended for use as is.
...
The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Pure Calculator, unless otherwise defined in this Privacy Policy.

**Information Collection and Use**

For a better experience while using our Service, I may require you to provide us with certain personally identifiable information, including but not limited to \[add whatever else you collect here, e.g. users name | address | location | pictures\]. The information that I request is \[retained on your device and is not collected by me in any way\]|\[will be retained by us and used as described in this privacy policy.
...
I may employ third-party companies and Pavels due to the following reasons:
